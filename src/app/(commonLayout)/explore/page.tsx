...
import { ExploreTourHero } from "@/components/modules/ExploreTour/ExploreTourHero";
import FeatureTourCard from "@/components/modules/Home/FeatureTourCard";
  ...
  const fetchListingsCities = async () => {
    try {
      ...
      if (response.success && response?.data?.data) {
        ...
        const uniqueCityList = cityData.reduce(
          (acc: any[], currentCity: any) => {
