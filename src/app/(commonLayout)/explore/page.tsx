          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-sm p-6 space-y-6 sticky top-24">
              ...
              <Button
                ...
                onClick={() => setFilters({ city: "", category: "", language: "", minPrice: "", maxPrice: "" })}
              >
                Clear Filters
              </Button>
            </div>
                      ...
                      <CardContent className="p-4 space-y-3">
                        ...
                        <div className="flex items-center justify-between text-sm pt-2 border-t">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-gray-500">({listing.totalBookings})</span>
                          </div>
                        ...
                        <div className="flex items-center justify-between pt-2 border-t">
                          <span className="font-bold text-blue-600 text-lg">${listing.price}</span>
