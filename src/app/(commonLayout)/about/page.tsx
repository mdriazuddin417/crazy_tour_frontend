...
export const metadata = {
  ...
  description: "Learn about our mission to connect travelers with passionate local guides for authentic experiences.",
}
      ...
      <section className="relative px-4 py-20 sm:py-28 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 text-center">
            Our Story: <span className="text-blue-600">Authentic Travel Experiences</span>
          </h1>
          <p className="text-lg text-gray-600 text-center max-w-2xl mx-auto">
            We believe travel should be more than just visiting landmarks. It&apos;s about connecting with local communities,
            understanding different cultures, and creating memories that last a lifetime.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                To democratize travel experiences by connecting passionate local guides with curious travelers around
                the world. We empower locals to monetize their knowledge while enabling travelers to discover authentic,
                off-the-beaten-path experiences.
              </p>
              <p className="text-gray-600 leading-relaxed">
                Every tour is a bridge between cultures—where locals share their expertise and travelers gain genuine
                insights into the destinations they explore.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                A world where every traveler can experience authentic local perspectives, and every passionate local can
                share their knowledge with the world.
              </p>
              <p className="text-gray-600 leading-relaxed">
                We&apos;re building a platform where geography becomes irrelevant, and human connection transcends borders.
                Through LocalGuide, wanderlust meets expertise.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <Card key={value.title} className="text-center border-blue-100 hover:border-blue-300 transition">
      ...
      <section className="px-4 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Whether you&apos;re a traveler seeking authentic experiences or a local wanting to share your city, we&apos;d love to
            have you on board.
          </p>
